        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="pages/keluhan/keluhan_proses.php?aksi=update&id=<?= $_GET['id'] ?>" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="answer" value="<?= $row['nama_user'] ?>"/>
                                    <div class="input-group-addon">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="answer" value="<?= $row['email_user'] ?>"/>
                                    <div class="input-group-addon">
                                        <i class="fa fa-user-circle"></i>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="answer" value="<?= $row['hp_user'] ?>"/>
                                    <div class="input-group-addon">
                                        <i class="fa fa-user-circle"></i>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="answer" value="<?= $row['keluhan'] ?>"/>
                                    <div class="input-group-addon">
                                        <i class="fa fa-user-circle"></i>
                                    </div>
                                </div>
