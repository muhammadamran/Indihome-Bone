...
<div id="content" class="content">
    ...
    <a href="index2.php?m=user&s=user">
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="pages/user/user_proses.php?aksi=update&id_user=<?= $_GET['id_user'] ?>" method="POST">
