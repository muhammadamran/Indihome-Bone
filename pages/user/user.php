      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a href="index2.php?m=user&s=user_add" target="_blank" class="btn btn-icon btn-sm btn-inverse"><i class="fa fa-plus-square"></i></a>
          </h4>
            ...
            ?>
              <tr>
                ...
                <td>
                    ...
                    <a href="index2.php?m=user&s=user_edit&id_user=<?= $row['id_user'] ?>" class="btn btn-sm btn-primary"><i class="fa fas fa-edit"></i></a>
                    <a href="index2.php?m=user&s=user_password&id=<?= $row['id_user'] ?>" class="btn btn-sm btn-secondary"><i class="fa fas fa-lock"></i></a>
