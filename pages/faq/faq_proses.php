...
if ($aksi == 'insert') {
    ...
    $insert = $db->query('INSERT INTO faq 
                        ...
                        ("'.$question.'","'.$answer.'")');
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "../../index2.php?m=faq&s=faq"</script>';
    } else {
    ...
    if ($update) {
        echo '<script>alert("Data berhasil diUpdate");location.href = "../../index2.php?m=faq&s=faq"</script>';
    } else {
