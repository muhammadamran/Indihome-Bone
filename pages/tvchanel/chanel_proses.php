...
if ($aksi == 'insert') {
    ...
    $insert = $db->query('INSERT INTO tv_chn 
                        ...
                        ("'.$channel.'","'.$paket_channel.'")');
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "../../index2.php?m=tvchanel&s=tvchanel"</script>';
    } else {
    ...
    if ($update) {
        echo '<script>alert("Data berhasil diUpdate");location.href = "../../index2.php?m=tvchanel&s=tvchanel"</script>';
    } else {
...
// HAPUS DATA
    ...
    if ($hapus) {
        echo '<script>alert("Data berhasil dihapus");location.href = "../../index2.php?m=tvchanel&s=tvchanel"</script>';
    } else {
