<?php
$data = $db->query('SELECT * FROM tv_chn WHERE id="'.$_GET['id'].'"');
...
<div id="content" class="content">
    <ol class="breadcrumb float-xl-right">
        ...
        <li class="breadcrumb-item active">Update Data Tv Chanel</li>
    </ol>
    <h1 class="page-header">Update Data Tv Chanel</h1>
        ...
        <div class="col-xl-12">
            <div class="panel panel-inverse" data-sortable-id="form-plugins-1">
                <div class="panel-heading">
                    <h4 class="panel-title">Update Data Tv Chanel</h4>
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="pages/tvchanel/chanel_proses.php?aksi=update&id=<?= $_GET['id'] ?>" method="POST">
