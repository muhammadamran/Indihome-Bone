      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a href="index2.php?m=tvchanel&s=chanel_add" target="_blank" class="btn btn-icon btn-sm btn-inverse"><i class="fa fa-plus-square"></i></a>
          </h4>
        ...
        <div class="alert alert-warning fade show">
          ...
          <p>Silahkan input <b>TV Channel Baru</b> Pada Button icon "<i class="fa fa-plus-square"></i>"</p>
        </div>
            ...
            ?>
              <tr>
                ...
                <td>  
                    ...
                    <a href="index2.php?m=tvchanel&s=chanel_edit&id=<?= $row['id'] ?>" class="btn btn-sm btn-primary"><i class="fa fas fa-edit"></i></a>
                ...
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label">Nama Chanel</label>
                        <div class="col-lg-8">
                    ...
                    <div class="form-group row">
                        <label class="col-lg-4 col-form-label">ID Chanel</label>
                        <div class="col-lg-8">
                            <div class="input-group">
...
<script>
  function deleteData(id) {
    ...
    if (r == true) {
      location.href = "pages/tvchanel/chanel_proses.php?aksi=hapus&id=" + id;
    }
  }
</script>