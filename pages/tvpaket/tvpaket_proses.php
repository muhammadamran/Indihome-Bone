...
if ($aksi == 'insert') {
    ...
    $insert = $db->query('INSERT INTO tv_paket 
                        ...
                        ("'.$id_tvpaket.'","'.$nama_tvpaket.'")');
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "../../index2.php?m=tvpaket&s=tvpaket"</script>';
    } else {
    ...
    if ($update) {
        echo '<script>alert("Data berhasil diUpdate");location.href = "../../index2.php?m=tvpaket&s=tvpaket"</script>';
    } else {
...
// HAPUS DATA
    ...
    if ($hapus) {
        echo '<script>alert("Data berhasil dihapus");location.href = "../../index2.php?m=tvpaket&s=tvpaket"</script>';
    } else {
