...
if ($aksi == 'insert') {
    ...
    $insert = $db->query('INSERT INTO content 
                        ...
                        ("'.$kuota.'","'.$status.'","'.$layanansatu.'","'.$layanandua.'","'.$layanantiga.'","'.$perangkat.'")');
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "../../index2.php?m=content&s=content"</script>';
    } else {
    ...
    if ($update) {
        echo '<script>alert("Data berhasil diUpdate");location.href = "../../index2.php?m=content&s=content"</script>';
    } else {
...
// HAPUS DATA
    ...
    if ($hapus) {
        echo '<script>alert("Data berhasil dihapus");location.href = "../../index2.php?m=content&s=content"</script>';
    } else {
