<div id="content" class="content">
    ...
    <a href="index2.php?m=content&s=content">
                ...
                <div class="panel-body panel-form">
                    <form class="form-horizontal form-bordered" action="pages/content/content_proses.php?aksi=insert" method="POST">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="layanandua" placeholder="Layanan Dua..." />
                                    <div class="input-group-addon">
                                        <i class="fa fa-at"></i>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="layanantiga" placeholder="Layanan Tiga..." />
                                    <div class="input-group-addon">
                                        <i class="fa fa-at"></i>
                                    </div>
                                </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-8">
                                <div class="input-group">
                                    <input type="text" class="form-control" name="perangkat" placeholder="Perangkat..." required/>
                                    <div class="input-group-addon">
                                        <i class="fa fa-user-circle"></i>
                                    </div>
                                </div>
