...
if ($aksi == 'insert') {
    ...
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "../../index2.php?m=produk&s=paket"</script>';
    } else {
    ...
    if ($beli) {
        echo '<script>alert("Data berhasil diUpdate");location.href = "../../index2.php?m=produk&s=paket"</script>';
    } else {
...
// PROSES CHANGE PASSWORD
    ...
    if ($change) {
        echo '<script>alert("Password berhasil diganti");location.href = "../../index2.php?m=barang&s=kelolaproduk"</script>';
    } else {
