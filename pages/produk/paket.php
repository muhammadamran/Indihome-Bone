...
<div class="container">
<h5 data-aos="fade-up">Berikut Paket Paket Yang Kami Sediakan</h5>
<br>
    <?php 
    ...
    <div class="card border-5 shadow-sm text-dark mb-3 overflow-hidden" data-aos="fade-up"> 
        <div class="card-body">
          ...
          <?php } else { ?>
            <div class="row">
                      ...
                      <div class="col-sm-12" style="">
                          <p>Harga Rp.<?= $row['harga'] ?>-</p>
                          <hr>
                          <a href="index.php?m=produk&s=beli&id=<?= $row['id'] ?>" class="beli">Pesan Produk</a>
                      </div>
                  </div>
