...
if ($aksi == 'insert') {
    ...
    $insert = $db->query('INSERT INTO ketersediaan 
                        ...
                        ("'.$id_user.'","'.$alamat.'","'.$email.'")');
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "../../index2.php?m=home&s=utama"</script>';
    } else {
...
// PROSES DATA UPDATE
    ...
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "../../index.php?m=bantuan&s=gangguan"</script>';
    } else {
        echo '<script>alert("Data gagal ditambahkan");history.go(-1)</script>';
    }
// PROSES DATA UPDATE
    ...
    if ($update) {
        echo '<script>alert("Data berhasil diUpdate");location.href = "../../index2.php?m=bodj&s=bodj"</script>';
    } else {
...
// HAPUS DATA
    ...
    if ($hapus) {
        echo '<script>alert("Data berhasil dihapus");location.href = "../../index2.php?m=bodj&s=bodj"</script>';
    } else {
