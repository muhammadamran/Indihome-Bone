      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a href="index2.php?m=barang&s=barang_add" target="_blank" class="btn btn-icon btn-sm btn-inverse"><i class="fa fa-plus-square"></i></a>
          </h4>
          ...
          <table id="data-table-buttons" class="table table-striped table-bordered table-td-valign-middle">
            ...
            <?php 
                $data = $db->query("SELECT produk.id as id, produk.kode_produk as kode_produk, produk.nama_produk as nama_produk, produk.keterangan as keterangan, produk.harga as harga, produk.telepon as telepon, produk.internet as internet, produk.paket as paket, tv_paket.nama_tvpaket as tv FROM (
                    produk INNER JOIN tv_paket ON produk.tv = tv_paket.id_tvpaket ) ORDER BY id DESC", 0);
                while($row = $data->fetch_assoc()) {
            ?>
              <tr>
                <td>#PROD-<?= $row['id'] == NULL ? "<i><font style='color:red;'>Not Found</font></i>" : $row['id'] ?></td>
                ...
                <td>
                    ...
                    <a href="index2.php?m=barang&s=barang_edit&id=<?= $row['id'] ?>" class="btn btn-sm btn-primary"><i class="fa fas fa-edit"></i></a>
