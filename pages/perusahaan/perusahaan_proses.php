...
if ($aksi == 'insert') {
    ...
    if ($insert) {
        echo '<script>alert("Data berhasil ditambahkan");location.href = "../../index2.php?m=perusahaan&s=perusahaan"</script>';
    } else {
    ...
    if ($update) {
        echo '<script>alert("Data berhasil diUpdate");location.href = "../../index2.php?m=perusahaan&s=perusahaan"</script>';
    } else {
...
// HAPUS DATA
    ...
    if ($hapus) {
        echo '<script>alert("Data berhasil dihapus");location.href = "../../index2.php?m=perusahaan&s=perusahaan"</script>';
    } else {
