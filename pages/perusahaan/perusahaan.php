      ...
      <div class="panel panel-inverse">
        <div class="panel-heading">
          <h4 class="panel-title">
            <a href="index2.php?m=perusahaan&s=perusahaan_add" target="_blank" class="btn btn-icon btn-sm btn-inverse"><i class="fa fa-plus-square"></i></a>
          </h4>
            ...
            ?>
              <tr>
                ...
                <td>  
                    ...
                    <a href="index2.php?m=perusahaan&s=perusahaan_edit&id=<?= $row['id'] ?>" class="btn btn-sm btn-primary"><i class="fa fas fa-edit"></i></a>
...
<script>
  function deleteData(id) {
    ...
    if (r == true) {
      location.href = "pages/perusahaan/perusahaan_proses.php?aksi=hapus&id=" + id;
    }
  }
</script>